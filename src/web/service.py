...
class ChatService:
    def __init__(self):
        ...
        self.embedding_model = HuggingFaceEmbeddings(
            model_name=r'D:\cache\modelscope\hub\models\BAAI\bge-base-zh-v1___5',
        ...
        self.neo4j_vectors = {
            'Trademark': self.index_utils('trademark_vector_index', 'trademark_fulltext_index'),
            'SPU': self.index_utils('spu_vector_index', 'spu_fulltext_index'),
            'SKU': self.index_utils('sku_vector_index', 'sku_fulltext_index'),
            'Category1': self.index_utils('category1_vector_index', 'category1_fulltext_index'),
            'Category2': self.index_utils('category2_vector_index', 'category2_fulltext_index'),
            'Category3': self.index_utils('category3_vector_index', 'category3_fulltext_index')
        }
        # 定义Parser
        self.json_parser = JsonOutputParser()
        self.str_parser = StrOutputParser()

    def index_utils(self, index_name, keyword_index_name):
